...
def load_data():
    if not os.path.exists("/home/ubuntu/URL-Shortener/storage.json"):
        return{}
    with open("/home/ubuntu/URL-Shortener/storage.json", "r") as f:
        return json.load(f)

def save_data(data):
    with open("/home/ubuntu/URL-Shortener/storage.json", "w") as f:
